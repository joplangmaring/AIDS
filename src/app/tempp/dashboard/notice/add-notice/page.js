                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="flex md:flex-row flex-col w-full gap-6">
                            <div className="flex flex-col w-full">
                                ...
                                <label htmlFor="description" className="font-semibold mt-4 mb-1">Description</label>
                                <textarea
                                    className="p-2 rounded bg-gray-700 text-white border-gray-600"
                                    name="description"
                                ...
                                <label htmlFor="date" className="font-semibold mt-4 mb-1">Date</label>
                                <input
                                    className="p-2 rounded bg-gray-700 text-white border-gray-600"
                                    type="date"
                                    name="date"
                            ...
                            <div className="flex flex-col">
                                <label htmlFor="file" className="font-semibold mb-1">Attach File</label>
                                <Image
                                    src={
                                        form.file !== ''
