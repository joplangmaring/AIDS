...
const Helpline = () => {
  return (
    <div className="bg-[#8B0000]">
      ...
      <div className="bg-[#8B0000] md:h-[30vh] flex flex-col md:flex-row justify-around px-6 md:px-32">
        {/* Text Section */}
        ...
        <div className="mt-5 md:mt-10 flex flex-col md:flex-row justify-center items-center gap-10 p-20">
          <Image
            src={scanner1}
            alt="Scanner 1"
            className="w-[100px] h-[100px] md:w-[200px] md:h-auto bg-white"
          />
          <Image
            src={scanner2}
            alt="Scanner 2"
            className="w-[100px] h-[100px] md:w-[200px] md:h-auto"
          />
        </div>
      </div>
